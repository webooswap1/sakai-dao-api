...
class ReferralRewardHistoryResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        $accumulatedAmountInWei = new BigNumber($this->last_amount);
        ...
        return [
            ...
            'accumulated_amount_in_wei'   => (string) $this->last_amount,
